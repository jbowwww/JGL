...
//				sb.Append("\n");
		...
		{
			Init(eventCache, source, eventType, id, null, data);
		}
		...
		{
			Init(eventCache, source, eventType, id, message, null);
		}
		...
		{
			Init(eventCache, source, eventType, id, format, data);
		}
		...
		public LogMessage(TraceEventCache eventCache, TraceSource source, System.Diagnostics.TraceEventType eventType, int id, Exception exception)
		{
			...
			message = sb.ToString();
			Init(eventCache, source, eventType, id, message);
		}
